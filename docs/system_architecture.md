...
**System Scope:** Level 1 Character Creation, Interactive Tabletop Sheet, Compendium Reference, and Offline PWA.
...
2. **Deterministic Rules Calculation Engine**:
...
3. **Information Density & Rules Traceability**:
...
|                           User Interface                              |
|   +-------------------+  +-------------------+  +------------------+  |
|   |  Creation Wizard  |  | Character Sheet   |  |   PHB Compendium |  |
|   |  (9 Step Flow)    |  | (Live Dice Table) |  |   (Quick Drawer) |  |
|   +---------+---------+  +---------+---------+  +--------+---------+  |
|             |                      |                     |            |
+-------------|----------------------|---------------------|------------+
              |                      |                     |
